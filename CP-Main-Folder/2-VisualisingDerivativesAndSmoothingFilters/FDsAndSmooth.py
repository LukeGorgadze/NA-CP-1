...
# Short summary of what i'm doing in this code: I'm converting 2d images to 1d then using finite differences on rgb channels separately
# you can uncomment 172-174 lines to see effects, to see more advanced smoothing and finite difference formulas using matrices
# or kernels open another file in this folder


# Answer to question: Can linear combination of second order derivatives with different
# spacing and function value itself work as smoothing filter?

# Yes, a linear combination of second-order derivatives with different spacing 
# and function values can be used as a smoothing filter.
...
# Display the result
im,res = GaussianSmoothing(image)
# res = firstDeriv(im,2)
res = secondDeriv(im,3)
# res = fourthDeriv(im,3)
