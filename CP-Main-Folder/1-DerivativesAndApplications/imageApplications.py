...
# Extra ideas, Finite differences can be used to create kernels (Smoothing filters, edge detection filters) which can be
# used in image processing to get awesome effects, here are my own implementations of GaussianSmoothing, SobelEdgedetection
# and Laplacian edge detection

# Note: Uncomment Line 120 for different result, you may also need to change sigma coefficient on line 36 for better visuals,
